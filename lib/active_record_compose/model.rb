...
module ActiveRecordCompose
  ...
  class Model
    ...
    begin
      ...
      # @!method self.delegate_attribute(*attributes, to:, allow_nil: nil)
      ...
      #   @param [Boolean, nil] allow_nil
      #     allow_nil Whether to allow nil values. Defaults to nil (treated as false if omitted).
      #   @example Basic usage
